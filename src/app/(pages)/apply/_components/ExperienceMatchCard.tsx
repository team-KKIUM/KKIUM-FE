...
export function ExperienceMatchCard({
  ...
  const handleKeyDown: React.KeyboardEventHandler<HTMLElement> = (event) => {
    ...
    if (event.defaultPrevented || event.target !== event.currentTarget || !onToggle) {
      return;
    }
  ...
  return (
    <article
      ...
      className={cn(
        ...
        isInteractive && 'cursor-pointer focus-visible:shadow-focus-ring focus-visible:outline-none',
        className,
      )}
      onClick={handleClick}
    ...
    >
      ...
      {expanded && <ExperienceAnalysisPanel analysis={analysis} />}
    </article>
  );
}
